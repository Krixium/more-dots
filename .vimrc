...
Plug 'ervandew/supertab'                "hack to fix tabs
...
let g:UltiSnipsSnippetDirectories=["~/.local/snippets", '~/.vim/plugged/vim-snippets/snippets']
...
" Make deoplete tabs go the right way
